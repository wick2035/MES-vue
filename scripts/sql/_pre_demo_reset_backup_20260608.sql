...
INSERT INTO `sp_bom_item` VALUES ('bom_item_case_power','bom_case_unit','POWER_SUPPLY','电源','10',1,'件','机箱装配',NULL,'PART','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin'),('bom_item_case_shell','bom_case_unit','CASE_SHELL','机箱','20',1,'件','机箱装配',NULL,'PART','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin'),('bom_item_half_case','bom_pc_host_half','CASE_UNIT','机箱单元','20',1,'件','机箱装配','bom_case_unit','COMP','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin'),('bom_item_half_mainboard','bom_pc_host_half','MAINBOARD_UNIT','主板单元','10',1,'件','主板装配','bom_mainboard_unit','COMP','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin'),('bom_item_host_half','bom_pc_host','PC_HOST_HALF','台式电脑主机半成品','10',1,'台','主机装配','bom_pc_host_half','PG','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin'),('bom_item_main_cpu','bom_mainboard_unit','CPU','CPU','20',1,'颗','主板装配',NULL,'PART','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin'),('bom_item_main_pcb','bom_mainboard_unit','PCB_BOARD','主板电路板','10',1,'件','主板装配',NULL,'PART','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin'),('bom_item_main_ram','bom_mainboard_unit','MEMORY','内存条','30',1,'条','主板装配',NULL,'PART','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='产品零部件定义';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sp_component_def` VALUES ('comp_case_unit','台式电脑主机','CASE_UNIT','机箱单元','COMP','由电源、机箱装配','0','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin'),('comp_mainboard_unit','台式电脑主机','MAINBOARD_UNIT','主板单元','COMP','由主板电路板、CPU、内存条装配','0','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin'),('comp_pc_host_half','台式电脑主机','PC_HOST_HALF','台式电脑主机半成品','PG','台式电脑主机一级半成品','0','2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin');
...
INSERT INTO `sp_equipment` VALUES ('eq_001','EQ000001','吊车','123','物料搬运','','1','0','2026-06-08 21:26:28','admin','2026-06-08 21:26:28','admin'),('eq_002','EQ000002','主板测试夹具','GJ-PCB-01','主板安装与测试的夹具','','1','0','2026-06-08 21:26:28','admin','2026-06-08 21:26:28','admin'),('eq_003','EQ000003','瓶体夹具','','瓶体加工夹具','','1','0','2026-06-08 21:26:28','admin','2026-06-08 21:26:28','admin'),('eq_004','EQ000004','手指套','','装配防护','防静电','1','0','2026-06-08 21:26:28','admin','2026-06-08 21:26:28','admin'),('eq_005','EQ000005','静电环','OWS20A','装配防静电','','1','0','2026-06-08 21:26:28','admin','2026-06-08 21:26:28','admin');
...
INSERT INTO `sp_inventory` VALUES ('2063991729695236098','2062753868678729730','2062753868741644291','mat_case','',1.0000,'件','0','2026-06-08 22:29:10','admin','2026-06-08 22:29:10','admin');
...
INSERT INTO `sp_materile` VALUES ('1284051625900748801','000001','成品测试','件','产品1组','FG','大',NULL,NULL,1,0,NULL,NULL,'8*8','1279942838902304770','0005','2020-07-17 17:05:39','admin','2020-07-21 08:32:19','admin','0'),('2062753465916493825','M000001','主机','SET',NULL,'PRODUCT','','SELF','OTHER',1,0,'2026/06/05/7d02bdddcf3742358705d180e917819e.png','',NULL,NULL,NULL,'2026-06-05 12:28:45','admin','2026-06-05 12:29:22','admin','0'),('mat_case','CASE_SHELL','机箱','件','台式电脑','PART','CASE-DEMO','OUT','钢板',1,0,NULL,'机箱单元零件','',NULL,NULL,'2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin','0'),('mat_case_unit','CASE_UNIT','机箱单元','件','台式电脑','COMP','CASE-UNIT','SELF','',1,0,NULL,'机箱组装工序产出','',NULL,NULL,'2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin','0'),('mat_cpu','CPU','CPU','颗','台式电脑','PART','CPU-DEMO','OUT','',1,0,NULL,'主板单元零件','',NULL,NULL,'2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin','0'),('mat_mainboard_unit','MAINBOARD_UNIT','主板单元','件','台式电脑','COMP','MAINBOARD-UNIT','SELF','',1,0,NULL,'主板装配工序产出','',NULL,NULL,'2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin','0'),('mat_pc_host','PC_HOST','台式电脑主机','台','台式电脑','FG','DESKTOP-HOST','SELF','',1,0,NULL,'工艺流程演示成品','',NULL,NULL,'2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin','0'),('mat_pc_host_half','PC_HOST_HALF','台式电脑主机半成品','台','台式电脑','PG','DESKTOP-HOST-HALF','SELF','',1,0,NULL,'主机装配工序产出','',NULL,NULL,'2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin','0'),('mat_pcb','PCB_BOARD','主板电路板','件','台式电脑','PART','PCB-ATX','OUT','FR-4',1,0,NULL,'主板单元零件','',NULL,NULL,'2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin','0'),('mat_power','POWER_SUPPLY','电源','件','台式电脑','PART','PSU-DEMO','OUT','',1,0,NULL,'机箱单元零件','',NULL,NULL,'2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin','0'),('mat_ram','MEMORY','内存条','条','台式电脑','PART','DDR-DEMO','OUT','',1,0,NULL,'主板单元零件','',NULL,NULL,'2026-06-08 21:26:30','admin','2026-06-08 21:26:30','admin','0');
...
INSERT INTO `sp_order` VALUES ('2063981067002806273','WO20260608214621','123',12,'P','1275430361590116354','CASE_SHELL','机箱','2026-06-08 00:00:00','2026-06-26 00:00:00',2,'1184019107907227649','超级管理员','1184019107907227649','超级管理员','2026-06-08 21:46:55','2026-06-08 21:46:48','admin','2026-06-08 21:46:56','admin');
...
INSERT INTO `sp_processing_unit` VALUES ('jg_unit_001','JG000001','电脑组装单元','person','台式电脑主机装配演示加工单元',8.00,'N','0','0','2026-06-08 21:26:28','admin','2026-06-08 21:26:30','admin'),('jg_unit_002','JG000002','加工单元1','device','PDF示例-轮毂上线工序所属单元',8.00,'N','0','0','2026-06-08 21:26:28','admin','2026-06-08 21:26:28','admin');
...
INSERT INTO `sp_sys_menu` VALUES ('1','currency','常规管理','#','0','1',1,'0','user:add','fa fa-address-book','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:30','admin'),('10','system','系统管理','#','1','2',99,'0','user:add','fa fa-gears','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:31','admin'),('101','menu','菜单管理','/admin/sys/menu/list-ui','10','3',1,'0','user:add','fa fa-bars','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:31','admin'),('102','user','用户管理','/admin/sys/user/list-ui','10','3',2,'0','user:add','fa fa-user','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:31','admin'),('103','role','角色管理','/admin/sys/role/list-ui','menu_perm_mgr','4',1,'0','user:add','fa fa-child','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:31','admin'),('104','department','部门管理','/admin/sys/department/list-ui','10','3',4,'0','user:add','fa fa-sitemap','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:31','admin'),('12','order','计划管理','','1','2',4,'0','user:add','fa fa-calendar','','2019-10-18 11:18:29','Wangziyang','2026-06-08 21:26:31','admin'),('121','orderRelease','工单下达','/order/release/list-ui','12','3',1,'0','user:add','fa fa-flag-o','','2019-10-18 11:18:29','Wangziyang','2026-06-08 21:26:31','admin'),('13','materiel','物料管理','#','legacy_hidden','2',99,'0','user:add','fa fa-cubes','','2019-10-18 11:18:29','Wangziyang','2026-06-08 21:26:31','admin'),('131','matdef','物料信息定义','/basedata/materile/list-ui','prod_data_center','3',1,'0','user:add','fa fa-microchip','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:31','admin'),('132','processing_unit','加工单元定义','/basedata/processing-unit/list-ui','base_data_center','3',3,'0','user:add','fa fa-cog','加工单元主数据','2026-05-28 22:33:00','admin','2026-06-08 21:26:31','admin'),('133','equipment','设备','/basedata/equipment/list-ui','base_data_center','3',4,'0','user:add','fa fa-wrench','设备主数据','2026-05-28 22:33:00','admin','2026-06-08 21:26:31','admin'),('14','Digitalplatform','数字化平台','#','1','2',6,'0','user:add','fa fa-pie-chart','','2019-10-18 11:18:29','Wangziyang','2026-06-08 21:26:32','admin'),('141','plandg','智慧大屏','/digitization/plan/plan-ui','14','3',1,'0','user:add','fa fa-desktop','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:31','admin'),('15','ProcessManage','工艺管理','','1','2',3,'0','user:add','fa fa-wrench','','2019-10-18 11:18:29','Wangziyang','2026-06-08 21:26:31','admin'),('151','flowProcess','工艺路线管理','/basedata/flow/process/list-ui','15','3',2,'0','user:add','fa fa-retweet','','2019-10-18 11:18:29','Wangziyang','2026-06-08 21:26:31','admin'),('152','bom','产品BOM管理','/technology/bom/list-ui','prod_data_center','3',3,'0','user:add','fa fa-file-text-o','产品BOM管理','2019-10-18 11:18:29','Wangziyang','2026-06-08 21:26:31','admin'),('153','sp_oper_def','工序信息定义','/technology/oper/list-ui','15','3',1,'0','user:add','fa fa-thumb-tack','工序信息定义','2026-05-28 22:33:00','admin','2026-06-08 21:26:31','admin'),('154','process_route','工艺流程管理','/technology/process-route/tree-ui','15','3',3,'0','user:add','fa fa-sitemap','工艺流程管理','2026-05-28 22:33:00','admin','2026-06-08 21:26:31','admin'),('155','process_content','工艺内容编制','/technology/process-content/tree-ui','15','3',4,'0','user:add','fa fa-edit','工艺内容编制','2026-05-28 22:33:00','admin','2026-06-08 21:26:31','admin'),('156','process_query','产品工艺查询','/technology/process-query/tree-ui','15','3',5,'0','user:add','fa fa-search','产品工艺查询','2026-05-28 22:33:00','admin','2026-06-08 21:26:31','admin'),('16','wip','在制品管理','#','1','2',5,'0','user:add','fa fa-industry','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:31','admin'),('161','generalSnProcess','SN通用过程采集','/wip/sn-process/list-ui','16','3',1,'0','user:add','fa fa-barcode','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:32','admin'),('17','DigitalSimulation','黑科数字孪生','#','1','2',7,'0','user:add','fa fa-ravelry','','2019-10-18 11:18:29','Wangziyang','2026-06-08 21:26:31','admin'),('171','DigitalSimulationFrom','数字仿真3D仓库','/digital/simulation/list-ui','17','3',1,'0','user:add','fa fa-codepen','','2019-10-18 11:18:29','Wangziyang','2026-06-08 21:26:31','admin'),('2','component','OPC操作','#','0','1',90,'0','user:add','fa fa-lemon-o','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:30','admin'),('3','other','其他管理','#','0','1',99,'0','user:add','fa fa-slideshare','','2019-10-18 11:18:29','SongPeng','2026-06-08 21:26:31','admin'),('banzu_def','banzuDef','班组员工定义','/basedata/team/list-ui','base_data_center','3',1,'0','user:add','fa fa-users','班组员工定义','2026-06-04 23:28:04','admin','2026-06-08 21:26:31','admin'),('base_data_center','baseDataCenter','基础数据中心','#','1','2',1,'0','user:add','fa fa-database','基础数据中心','2026-06-04 23:28:04','admin','2026-06-08 21:26:31','admin'),('bianzu_def','bianzuDef','编组设备定义','/basedata/equipment-group/list-ui','base_data_center','3',2,'0','user:add','fa fa-wrench','编组设备定义','2026-06-04 23:59:38','admin','2026-06-08 21:26:31','admin'),('cangku_def','cangkuDef','库房库位定义','/basedata/warehouse/list-ui','base_data_center','3',3,'0','user:add','fa fa-cube','库房库位定义','2026-06-05 12:02:22','admin','2026-06-08 21:26:31','admin'),('component_def','componentDef','零部件定义','/technology/component/list-ui','prod_data_center','3',2,'0','user:add','fa fa-cubes','零部件定义','2026-06-08 21:26:29','admin','2026-06-08 21:26:31','admin'),('inventory_mgmt','inventoryMgmt','库存管理','/basedata/inventory/list-ui','base_data_center','3',3,'0','user:add','fa fa-archive','库存管理','2026-06-08 22:11:47','admin','2026-06-08 22:11:47','admin'),('mat_info_def','matInfoDef','matInfoDefHidden','/basedata/materile/list-ui','legacy_hidden','3',99,'0','user:add','fa fa-info-circle','物料信息定义','2026-06-05 12:01:27','admin','2026-06-08 21:26:31','admin'),('menu_perm_mgr','permManage','权限管理','#','10','3',3,'0','','layui-icon-lock','权限管理目录','2026-05-26 09:50:17','admin','2026-06-08 21:26:31','admin'),('prod_data_center','prodDataCenter','产品数据中心','#','1','2',2,'0','user:add','fa fa-cubes','生产数据中心','2026-06-05 12:01:27','admin','2026-06-08 21:26:31','admin');
...
-- Dump completed on 2026-06-08 22:43:21
